...
app.post('/usuarios/login', (req, res)=>{
    if(req.body.usuario == "" ||
       ...
       conexao.query("select * from usuario where nomeusuario=? and senha=?", req[req.body.nomeusuario,req.body.senha],(error, data)=>{
...
app.put('/usuarios/atualizar/:id',(req, res)=>{
    conexao.query("update usuario set ? where id=?", req[req.body,req.params.id], (error, data)=>{
